...
//        String strUrl = "http://wptrafficanalyzer.in/p/demo1/first.php/countries";
        String strUrl = "http://apis.daum.net/contents/movie?apikey=15a987ee6dac45509a54c36d38b1c8dbbb5c8e10&q=key&output=json";
    ...
    private String downloadUrl(String strUrl) throws IOException{
        ...
        try{
        		String temp = URLEncoder.encode(strUrl, "utf-8"); 
        		Log.e("tag", temp);
...
//	        			,R.id.iv_flag
	        			,R.id.tv_country_details};

	        // Instantiating an adapter to store each items
	        // R.layout.listview_layout defines the layout of each item	        
	        SimpleAdapter adapter = new SimpleAdapter(getBaseContext(), movies, R.layout.lv_layout, from, to);  
